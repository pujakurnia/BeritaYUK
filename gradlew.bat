...
<!-- blaze-out/gcc-4.X.Y-crosstool-v18-llvm-grtev4-k8-opt/genfiles/java/com/google/android/gmscore/integ/client/base/res/values-eu/strings.xml -->
<eat-comment/>
...
<string name="common_google_play_services_notification_channel_name" msgid="4293541511340436975">"Google Play zerbitzuen erabilgarritasuna"</string>
...
<string name="common_google_play_services_updating_text" msgid="7894275749778928941">"<xliff:g id="APP_NAME">%1$s</xliff:g> ez da exekutatuko Google Pl